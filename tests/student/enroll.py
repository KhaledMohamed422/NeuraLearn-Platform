...
class JWTClient:
    ...
    def enroll(self, endpoint=None, slug=None):
        """
        ...
        if endpoint is None or self.base_endpoint not in str(endpoint):
            endpoint = f"http://localhost:8000/api/students/courses/{slug}/enroll/" 
...
if __name__ == "__main__":
    ...
    client = JWTClient() 
    slug = input("Enter Course Slug: ")
    lookup_1_data = client.enroll(slug=slug)