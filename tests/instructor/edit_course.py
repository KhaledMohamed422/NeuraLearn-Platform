...
class JWTClient:
    ...
    def perform_auth(self):
        ...
        collection process.
        """
        endpoint = f"{self.base_endpoint}/jwt/create/" 
    ...
    def verify_token(self):
        ...
        endpoint = f"{self.base_endpoint}/jwt/verify/" 
    ...
    def perform_refresh(self):
        ...
        endpoint = f"{self.base_endpoint}/jwt/refresh/" 
    ...
    def edit(self, endpoint=None, data=None, files=None, slug=None):
        """
        ...
        if endpoint is None or self.base_endpoint not in str(endpoint):
            endpoint = f"http://localhost:8000/api/courses/{slug}/edit/" 
        r = requests.put(endpoint, headers=headers, data=data, files=files)
        print(r.json())
        print(r.status_code)
        data = r.json()
        return data
...
if __name__ == "__main__":
    ...
    with open(image_path, 'rb') as file:
        # files = {'image': ""}
        slug = input("enter slug for course")
        lookup_1_data = client.edit(data=data, files=files, slug=slug)